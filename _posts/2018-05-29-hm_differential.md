...
$$f(x_2)-f(x_1)=f'(\xi)(x_2-x_1)\quad(\xi\in(x_1,x_2)\subset(a,b))$$    
...
$$f(x+\Delta x)-f(x)=f'(\xi)[(x+\Delta x)-x]$$   
...
$$\Delta y=f'(x+\theta\cdot\Delta x)\cdot\Delta x$$    
&ensp;&ensp;如果在式(4.1.6)中,令$x=x_0$带入,有  
$$f(x_0+\Delta x)-f(x_0)=f'(x_0+\theta\cdot\Delta x)\cdot\Delta x$$  
